...
$(document).ready(function() {
	...
	$("#breadInitial").show();
	 ...
	 $("#button3").click(function(){
	 	const programmeur = getprogrammeur();
	 	$("#chosenprogrammeur").html(programmeur);
	 	
	 	let av;
	 	if (programmeur == "no preferences") {
			av = "monday - saturday";
    	} else if (programmeur == "Julius Caesar") {
    		av = "monday, wednesday, friday";
    	} else if (programmeur == "Anna Green") {
